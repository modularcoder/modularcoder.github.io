...
const SectionArticles = async () => {
  ...
  const postsRecent = posts.slice(0, 4)

  return (
    <section>
      <header className="mb-20">
        <div>
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-blue-500 inline ">
            Recent articles
          </h2>
        </div>
            ...
            <div className="flex flex-row space-x-12">
              ...
              <div className="flex-1 flex flex-col space-y-8 ">
                <Link href={`/blog/${post.slug}`} className="group">
                  <h2
                    className=" mb-4
                      text-3xl font-semibold bg-clip-text
