...
export default async function Home() {
  ...
  const projectsRecent = posts.slice(3, 6)
    ...
    <main className="min-h-full pb-10">
      ...
      <div className="py-16 mb-40 ">
        <div className="container mx-auto">
          <header className="mb-20">
            <div>
              <h2 className="sm:text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-blue-300 inline ">
                Side projects
              </h2>
            </div>
            <p className="text-lg">
              Open source, demo and just for fun projects
            </p>
          </header>

          <div className="grid grid-cols-3 gap-16 mb-16">
            {projectsRecent.map((post) => (
              <Link href={`/blog/${post.slug}`} className="group" key={post.id}>
                <div
                  className="
                transition p-6 hover:bg-zinc-100 rounded-2xl
                ...
                >
                  ...
                  <div className="space-y-8">
                    ...
                    <h2
                      ...
                      text-2xl font-semibold bg-clip-text
                      text-transparent bg-gradient-to-r
                      transition-colors text-zinc-600
                      group-hover:text-pink-500
                    "
                    >
                      {post.title}
